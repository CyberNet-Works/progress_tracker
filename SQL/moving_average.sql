...
Task: Write an SQL query to compute the moving average (as average_amount) of how much the customers paid in a seven days window (i.e., current day + 6 days before).
